...
function initArrowsForContainer(container, sourceId, targetId, lineId) {
...
// Auto-initialize for all canvases with arrows
// Example: first canvas, arrow from el1 to el2 using line with id arrow1
const containers = document.querySelectorAll('.cameraViewContainer');
if (containers.length > 0) {
    const first = containers[0];
    initArrowsForContainer(first, 'el1', 'el2', 'arrow1');
}
// To add more, call initArrowsForContainer for each canvas as needed
